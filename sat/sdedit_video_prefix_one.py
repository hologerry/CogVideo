...
def sampling_main(args, model_cls):
    ...
    if args.sdedit_prefix_gt or view_idx == 0:
        ...
        zero123_cogvxlora_out = f"/data/Dynamics/cogvideox_lora_outputs/5b_lora_all_sdedit_zero123/"
        output_dir = f"zero123_finetune_15000_cam0to{view_idx}_cogvideox_5b_all_pred_overlap_cache/overlap_output_strength0d26_frames"
