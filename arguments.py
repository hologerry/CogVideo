...
def add_sdedit_config_args(parser):
    ...
    group.add_argument("--sdedit-sequence-name", type=str, default="sim_000000")
    group.add_argument("--sdedit-prefix-start-idx", type=int, default=81)
    group.add_argument("--sdedit-prefix-start-idx-one", type=int, default=81)
    group.add_argument("--sdedit-prefix-start-idx-two", type=int, default=81)
    group.add_argument("--sdedit-prefix-start-idx-three", type=int, default=81)
    group.add_argument("--sdedit-prefix-num-frames", type=int, default=9)
    group.add_argument("--sdedit-start-idx", type=int, default=-1)
    group.add_argument("--sdedit-label-start-idx", type=int, default=-1)
    group.add_argument("--sdedit-start-idx-one", type=int, default=-1)
    group.add_argument("--sdedit-label-start-idx-one", type=int, default=-1)
    group.add_argument("--sdedit-start-idx-two", type=int, default=-1)
    group.add_argument("--sdedit-label-start-idx-two", type=int, default=-1)
    group.add_argument("--sdedit-start-idx-three", type=int, default=-1)
    group.add_argument("--sdedit-label-start-idx-three", type=int, default=-1)
    group.add_argument("--sdedit-num-frames", type=int, default=49)
    group.add_argument("--sdedit-frame-step", type=int, default=1)
    ...
    group.add_argument("--sdedit-zero123-finetune-step", type=int, default=15000)
