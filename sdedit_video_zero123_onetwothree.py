...
def sampling_main(args, model_cls):
    ...
    max_frame_idx = 160 if "Scalar" in frames_dir else 409
    ...
    for index in range(len(cur_poststrs)):
        ...
        # .replace("80000", "88000")
        cogvx_output_dir = zero123_output_dir.replace("for_cogvideox", f"cogvideox_5b_all_pred_{cur_poststr}")
        ...
        frames_tensor = cur_frames_tensor
