...
def sampling_main(args, model_cls):
    ...
    prefix_output_dir = zero123_output_dir.replace("for_cogvideox", "cogvideox_5b_all_pred_prefix_one")
    if "blue" in args.output_dir:
        prefix_basename = f"output_sfi055_nf65_strength0d3_frames"
    elif "red" in args.output_dir:
        prefix_basename = f"output_sfi033_nf65_strength0d3_frames"
    prefix_output_full_dir = os.path.join(args.output_dir, prefix_output_dir, prefix_basename)

    cogvx_output_dir = zero123_output_dir.replace("for_cogvideox", f"cogvideox_5b_all_pred_prefix_two")
