...
def load_label(label_folder, start_frame_idx=90, max_frame_idx=110, view_idx=0, sequence_name="sim_000000"):
    ...
    # blueanother
    # label_name = f"seq_10_26_17_12_03_cam_{view_idx:02d}_start_{frame_idx:03d}_frames_049.txt"
    # redanother
    # label_name = f"seq_10_25_01_29_23_cam_{view_idx:02d}_start_{frame_idx:03d}_frames_049.txt"
